...
CHATBOTS = {
    'meliksah': {
        ...
        'contact_modal_subtitle': '**Size sunacaklarımız:**\n\n✓ Düzenli hatırlatma mailleri ve mesajları\n✓ 1 dakikalık karakter & psikoloji analizleri\n\nİstemiyorsanız **"Geç"** deyin, direkt chat\'e başlayın.',
...
@app.route('/sommez-24941930940ads0f')
def sonmez_chat():
    """Sönmez chat page."""
    return render_template('chat.html', bot=CHATBOTS['sonmez'])

@app.route('/neslihan')
def neslihan_chat():
    """Neslihan chat page."""
    return render_template('chat.html', bot=CHATBOTS['neslihan'])
